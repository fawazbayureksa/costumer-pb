...
import { ProfilePicture, ChatAttachment, ChatAttachment2, ChatMessageType } from "./Helper";
...
const InputChatMessage = (props) => {
    ...
    return (<>
        ...
        {
            (showPicker) &&
                <EmojiPicker onEmojiSelect={(data) => setEmoji(data)} />
        }
...
const ChatMessage = (props) => {
    ...
    const renderMessage = (user, message, backgroundColor) => (<>
        {message.type === ChatMessageType.Text ? <div className="p-3 rounded" style={{ backgroundColor: backgroundColor }}>
            ...
            : message.type === ChatMessageType.Product ? <div className="p-3 rounded" style={{ backgroundColor: backgroundColor, minWidth: 500 }}>
    ...
    return (
        <div className="h-100" style={{ display: 'grid', gridTemplateRows: 'auto 1fr auto' }}>
