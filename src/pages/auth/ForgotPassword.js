           ...
           <Template>
            <Style/>
                <div className="resend-form mx-auto my-5 p-5">
                    ...
                    <div className="mb-5">
                        <h3 style={{ textAlign: 'center'}} className="text accent-color font-weight-bold">{this.props.t('auth_form.forgot_password')}</h3>
                    </div>
                    <div className="resend-gap">
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="row">
                                <div className="col-6 ">
                                    <button className="btn bgc-accent-color font-weight-bold btn-resend my-3" style={{fontSize:"16px"}} disabled={this.state.submitting} onClick={this.forgotPassword}>{this.state.timeLeft ? this.state.timeLeft + " detik" : this.props.t('general.send')}</button>
                                </div>
                            </div>
                            <div >
